...
var choix_niv = ''; // Déclarer la variable en dehors du gestionnaire d'événement
...
var boutonLancerPartie = document.getElementById("lancerPartie");

boutonLancerPartie.addEventListener("click", function() {
});
